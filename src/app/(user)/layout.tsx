          ...
          <div className="flex flex-col h-full pb-12">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="">
                ...
                <p className="text-[#A8A8A8] text-xs font-medium">{session?.data?.user?.email}</p>
              </div>
            </div>
            <button onClick={() => signOut()} className="text-white bg-blue-500 mt-3 p-2 rounded">Sign out</button>
          </div>
        </div>
